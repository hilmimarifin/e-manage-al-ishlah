...
export default function ClassesPage() {
  ...
  const columns: ColumnDef<Class>[] = [
    ...
    },
    {
      ...
      header: "Wali Kelas",
      cell: ({ row }) => <div>{row.getValue("teacherName") || "No teacher"}</div>,
    },
    {
      accessorKey: "monthlyFee",
      header: "Biaya SPP",
      cell: ({ row }) => <div>{row.getValue("monthlyFee") || "No monthly fee"}</div>,
    },
        ...
        <div className="flex items-center justify-between">
          ...
          {showAddButton && (
            <Modal
              ...
              description={selectedClass ? 'Make changes to the classes here.' : 'Add a new classes to the system.'}
              trigger={
